    ...
    <div class="app-brand demo">
        <a href="/" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img src="/uimg/logo.jpg" style="width: 15%; height: 15%;">
                  <defs>
                    <path
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">SBDS</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="/match/findimpl" class="menu-link">
        ...
        <li class="menu-item">
            <a href="/mate/all " class="menu-link">
                <i class="menu-icon tf-icons bx bx-run"></i>
                <div data-i18n="Basic">메이트 관리</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/matereview/allpage" class="menu-link">
        ...
        <li class="menu-item">
            <a href="/itemreview/all" class="menu-link">
                <i class="menu-icon tf-icons bx bx-book-reader"></i>
                <div data-i18n="Basic">후기 관리</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            ...
            <a href="/notice/allpage" class="menu-link">
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                <div class="avatar avatar-online">
                    <img src="/uimg/snapshot_982.jpg" alt class="w-px-40 h-auto rounded-circle"/>
                </div>
            </a>
                    ...
                    <a class="dropdown-item" href="#">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <span class="fw-semibold d-block">${loginadm.adminId}</span>
