            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="/" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="/uimg/logo.jpg" style="display: block; margin: 0 auto; width: 50%; height: 50%;">
                      <defs>
                        <path
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">SBDS</span>
                </a>
              </div>
              <!-- /Logo -->
              <p class="mb-4">Welcome to Make your Admin Account!</p>
              ...
              <form id="register_form" class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="adminId" name="adminId" placeholder="Enter your Admin ID" />
                  <span id="idspan"></span>
                </div>
                ...
                <button id="register_btn" type="button" class="btn btn-primary d-grid w-100">Register</button>
              </form>
        ...
        init:function (){   //클릭 시, send 후 register_form 초기화
          ...
          $('#pwd2').on('input',function (){
            ...
            if (pwd.length < 4 || pwd.length > 10) {
              window.alert('비밀번호는 4글자 이상, 10글자 이하만 이용 가능합니다.');  //경고 알러트창 띄우기.
