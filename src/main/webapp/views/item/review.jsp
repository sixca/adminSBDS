...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">상품 리뷰 관리 /</span> Item Review Management</h4>

        <!-- Basic Bootstrap Table -->
        <div class="card">
            <h5 class="card-header">상품 리뷰 현황</h5>
            <div class="card-body">

                <div class="row gx-3 gy-2 align-items-center justify-content-center">

                    <div class="col-md-2">
                        <label class="form-label" for="name">제품 번호</label>
                        <input id="name" class="form-control me-2" type="text" name="search1">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label" for="license">작성자</label>
                        <input id="license" class="form-control me-2" type="text" name="search2">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label" for="area">제목</label>
                        <input id="area" class="form-control me-2" type="text" name="search3">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label" for="area">리뷰</label>
                        <input id="area" class="form-control me-2" type="text" name="search3">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label" for="color">평점</label>
